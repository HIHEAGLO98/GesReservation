    ...
    <div class="col-md-6">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title"><i class="fas fa-user-plus fa-2x"></i> Formulaire d'ajout d'une ville</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form role="form" wire:submit.prevent="addVille()">
              @csrf
            <div class="card-body">
              <div class="form-group">
                <label> Ville</label>
                <input type="text" class="form-control @error('newVille.nom_ville') is-ivalid @enderror" wire:model="newVilles.nom_ville">
               @error("newVilles.nom_ville")

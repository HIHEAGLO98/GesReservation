        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{ $tickets }}</font></font></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-8">
          ...
          <div class="card">
            ...
            <div class="card-footer clearfix">
              ...
              <a href="{{ route('admin.evenement.bookings.list') }}" class="btn btn-sm btn-secondary float-right"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Voir toutes les réservations</font></font></a>
            </div>
            <!-- /.card-footer -->
          </div>
          <!-- /.card -->
